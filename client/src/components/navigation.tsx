      ...
      <aside className="hidden md:flex md:flex-col w-64 bg-card border-r border-border">
        <div className="p-6 border-b border-border">
          <div className="flex flex-col items-center space-y-3">
            ...
            <div className="text-center">
              <h1 className="text-lg font-bold text-foreground">목동에이원과학학원</h1>
        ...
        <nav className="flex-1 p-4">
          <ul className="space-y-2">
            ...
            <li>
              <Link href="/analytics" data-testid="nav-analytics" className={`w-full flex items-center space-x-3 px-4 py-3 rounded-lg font-medium transition-colors ${
                location === '/analytics' 
                  ? 'bg-primary text-primary-foreground' 
                  : 'text-foreground hover:bg-muted'
              }`}>
            ...
            <li>
              <Link href="/reports" data-testid="nav-reports" className={`w-full flex items-center space-x-3 px-4 py-3 rounded-lg font-medium transition-colors ${
                location === '/reports' 
                  ? 'bg-primary text-primary-foreground' 
                  : 'text-foreground hover:bg-muted'
              }`}>
